...
def extract_campaign_cards(page) -> list[dict]:
    ...
    for card in cards:
        try:
            ...
            # Başlık (gradientTitle sınıfını arıyoruz)
            title_el = card.query_selector("p.gradientTitle")
            title = title_el.inner_text().strip() if title_el else None

            # Etiket / Kategori (İkon yanındaki metin içeren div)
...
def main():
    ...
    print("=" * 60)
    print("Hayat Finans Kampanya Scraper başlatılıyor...")
    print("=" * 60)
